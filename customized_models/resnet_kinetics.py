...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet18_v1b_kinetics400', 'resnet34_v1b_kinetics400']


model_urls = {
    'resnet18': 'https://download.pytorch.org/models/resnet18-5c106cde.pth',
    'resnet34': 'https://download.pytorch.org/models/resnet34-333f7ec4.pth',
    'resnet18_v1b_kinetics400': 'https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/torch/models/resnet18_v1b_kinetics400-854b23e4.pth',
    'resnet34_v1b_kinetics400':'https://apache-mxnet.s3-accelerate.dualstack.amazonaws.com/torch/models/resnet34_v1b_kinetics400-124a2fa4.pth'
}
...
class DistillerBottleneck(nn.Module):
...
class ResNet(nn.Module):
    ...
    def __init__(
        self,
        block: Type[Union[BasicBlock, DistillerBasicBlock, DistillerBottleneck]],
        layers: List[int],
        ...
        if zero_init_residual:
            for m in self.modules():
                if isinstance(m, BasicBlock) or isinstance(m, DistillerBasicBlock) or isinstance(m, DistillerBottleneck):
                    nn.init.constant_(m.bn2.weight, 0)  # type: ignore[arg-type]

    def _make_layer(self, block: Type[Union[DistillerBottleneck, DistillerBasicBlock, BasicBlock]], planes: int, blocks: int,
...
def resnet18_v1b_kinetics400(pretrained: bool = False, progress: bool = True, **kwargs: Any):
...
def resnet34_v1b_kinetics400(pretrained: bool = False, progress: bool = True, **kwargs: Any):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
